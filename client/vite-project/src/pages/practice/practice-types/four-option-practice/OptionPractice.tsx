...
import { EN_LC_LOADING_TEXT, EN_UC_CHARACTER_PRACTICE_HEADER, EN_UC_LEAVE_HEADER, EN_UC_PINYIN_PRACTICE_HEADER, EN_UC_TRADITIONAL_PRACTICE_HEADER } from '../../../../global/Strings';
import { AnimationManager } from '../../../../scripts/AnimationManager';
import { ArrayShuffler } from '../../../../scripts/ArrayShuffler';
import { PinyinManager } from '../../../../scripts/PinyinManager';
    ...
    const generateCurrentQuestion = () => {
        ...
        switch (lessonType) {
            ...
            case 'definition':
                ...
                break;
            case 'measure':
                const inputString = currentAnswer?.definition || '';
                const delimiter = 'CL:';

                const delimiterIndex = inputString.indexOf(delimiter);
                const result = delimiterIndex !== -1 ? inputString.substring(delimiterIndex).trim() : inputString;
