        ...
        <form action='' noValidate onSubmit={handleSubmit}>
          ...
          <div className="login-page-sub-buttons">
            <div className='login-page-remember-me'>
              <label><input type='checkbox' name='rememberMe'/> {EN_UC_REMEMBER_ME}</label>
            </div>
            <div className='login-page-forgot-password'>
              <label className='login-page-reset-link' onClick={() =>setShowResetPassword(showResetPassword => !showResetPassword)}>{EN_UC_FORGOT_PASSWORD}</label>
            </div>
          </div>
          <button type='submit' className='login-page-login-btn'>{EN_UC_LOGIN_HEADER}</button>
          <div className='login-page-login-link'>
            <p>{EN_UC_NO_ACCOUNT} <Link to='/register' className='login-page-link login-page-login-link'>{EN_UC_REGISTER_HEADER}</Link></p>
          </div>
        </form>
      </div>
      ) : (
            ...
            (
              <>
                <form action='' noValidate onSubmit={handleCode}>
                  ...
                  <button type='submit' className='login-page-login-btn'>{EN_UC_SEND_CODE}</button>
                  <div className='login-page-login-link'>
                    <p>{EN_UC_KNOW_PASSWORD} <span className='login-page-link login-page-login-link' onClick={() =>setShowResetPassword(showResetPassword => !showResetPassword)}>{EN_UC_LOGIN_HEADER}</span></p>
                  </div>
                </form>
              </>
            ) : (
                <>
                  ...
                  {!showPasswordReset ? (
                    <>
                      ...
                      <button type='submit' className='login-page-login-btn'>{EN_UC_CONFIRM_HEADER}</button>
                      <div className='login-page-login-link'>
                        <p><span className='login-page-link login-page-login-link' onClick={handleCode}>{EN_UC_RESEND_CODE}</span></p>
                      </div>
                    </>
                  ) : (
                    <>
                      ...
                      <div className="login-page-input-box">
                      <input type='password' name='passwordForResetVerify' placeholder='Confirm password' value={passwordForResetVerify} onChange={handlePasswordVerifyChange} required />
                        <FontAwesomeIcon icon={faLock} className='login-page-icon'/>
                      </div>
                      <button type='submit' className='login-page-login-btn' onClick={handleReset}>{EN_UC_RESET_PASSWORD}</button>
                    </>
                  )}
                </form>
              </>
