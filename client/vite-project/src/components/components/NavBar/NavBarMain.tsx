...
function NavBarMain() {
    ...
    useEffect(() => {
        axios
            .post(API_CALCULATE_LEVEL_URL, { userId: authState.id })
            .then((response): void | undefined => {
        ...
        <div>
                ...
                <ul className="nav-links">
                    {!authState.status ? (
                        <>
                            ...
                            <Link to="/login">
                                <li className="nav-link-item">Login</li>
                            </Link>
                        </>
                    ) : (
                        <div className="nav-logged-in-menu">
                            <Link to="/learn">
                                <li className="nav-link-item">Learn</li>
                            </Link>
                            <Link to="/practice">
                                <li className="nav-link-item">Practice</li>
                            </Link>
                            ...
                            <li
                                ...
                                <span className="fa-layers fa-fw">
                                    <FontAwesomeIcon
                                        icon={faCircle}
                                        className="nav-profile-background"
                                    />
                                    <FontAwesomeIcon
                                        icon={faUser}
                                        className="nav-profile-pic"
                                    />
                                    <p className="nav-profile-text-name">
                                        {' '}
                                        {authState.email.length > 8
                                            ? `${authState.email.substring(
                                                  0,
                                                  8
                                              )}...`
                                            : authState.email}
                                    </p>
                                    <p className="nav-profile-text-level">
                                        {userMastery || 'Novice'}
                                    </p>
                                </span>
                            </li>
                            <li className="nav-link-item">
                                ...
                                <Link to="/search">
                                    <FontAwesomeIcon
                                        ...
                                        className="nav-icon nav-link-item"
                                    />
                                </Link>
                            </li>
                        </div>
                            ...
                            <ul>
                                <Link to="/profile" className="link">
                                    <li className="nav-profile-sub-menu-link-item">
                                        <FontAwesomeIcon
                                            icon={faUser}
                                            className="nav-profile-sub-menu-icon"
                                        />
                                        Profile
                                    </li>
                                </Link>
            ...
            {mobileVisible && (
                <div className="mobile-nav-menu" ref={mobileRef}>
                        ...
                        {!authState.status ? (
                            <>
                                <Link to="/" className="link mobile-link">
                                    <h1 className="nav-logo nav-mobile-logo">
                                        {EN_UC_WEBSITE_NAME}
                                    </h1>
                                </Link>
                            </>
                    ...
                    <FontAwesomeIcon
                        icon={faBell}
                        className="nav-icon nav-mobile-icon"
                    />
