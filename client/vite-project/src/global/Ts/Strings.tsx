...
export const EN_UC_LEARN_HANZI_DYNAMIC_DESCRIPTION = (hskLevel: number) => {return `Learn all HSK ${hskLevel} words and vocabulary. This is recommended to take prior to taking other lessons.`};
export const EN_UC_LEARN_HSK_HEADER = "Learn HSK";
export const EN_UC_REVIEW_HANZI_HEADER = "Review hanzi";
export const EN_UC_REVIEW_HANZI_DYNAMIC_HEADER = (reviewItems: number) => {return `Review ${reviewItems} hanzi`};
export const EN_UC_REVIEW_HANZI_EMPTY_HEADER = "No hanzi to review";
export const EN_UC_LEARN_HANZI_DYNAMIC_HEADER = (hskLevel: number) => {return `Learn HSK ${hskLevel}`};
...
export const EN_UC_LESSONS_DYNAMIC_HEADER = (hskLevel: number) => {return `HSK ${hskLevel} lessons`};
...
export const API_USER_STATS_URL = (userID: number) => {return `http://localhost:3001/api/stats/${userID}`};
